...
// BUDGET_USD=1. MAX_ITER спрацьовує ДО нового coordinator-а, але не рахує субагентні виклики
// всередині ходу; фінансову стелю ставить провайдер. Заразом зникла єдина причина парсити
// stream-json, а з нею — і вся таблиця адаптерів під кожен інструмент.
//
// ── ЩО САМЕ Є МЕТРИКОЮ ───────────────────────────────────────────────────────────────
